...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <br />
    <h2 style="text-align:center; font-weight:bolder;">Autoři:</h2>
   ...
   <br />
    ...
    <h2 style="text-align:center; font-weight:bolder;">Clanky:<asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataSourceID="SqlDataSource2" GridLines="Horizontal" style="margin: auto; font-size: 25px; font-family:'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="komentar" HeaderText="Komentář redaktora" SortExpression="komentar"/>
        </Columns>
